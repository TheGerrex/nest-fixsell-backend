...
export class ProductOperationsLogisticsController {
  constructor(
    private readonly productOperationsLogisticsService: ProductOperationsLogisticsService,
  ) {}
  ...
  create(
    ...
    return this.productOperationsLogisticsService.create(
  ...
  update(
    ...
    return this.productOperationsLogisticsService.update(
      +id,
