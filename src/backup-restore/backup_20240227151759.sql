...
COPY public.consumible (id, name, price, "longDescription", category, brand, sku, color, yield, "counterpartId", "compatibleModels", currency, img_url, volume, origen, "shortDescription") FROM stdin;
91a8c30d-df9a-433e-bc6d-4659f106b7a8	aasdf	0.05		Toner	asdf	asdfasdf	K	7	\N	{""}	USD	{}	\N	OEM	
\.
...
COPY public.deal (id, "dealEndDate", "dealStartDate", "dealPrice", "dealDiscountPercentage", "dealDescription", "dealCurrency") FROM stdin;
1	2024-12-31 17:59:59.999	2022-12-31 18:00:00	25000	20	Hello	\N
3	2024-02-26 18:00:00	2024-02-25 18:00:00	80	20	asdf	\N
4	2024-02-27 18:00:00	2024-02-25 18:00:00	80	20	asdfasdwerf	USD
\.
...
COPY public."user" (id, email, name, password, "isActive", roles) FROM stdin;
ddbb6363-2bb3-4e46-93ec-ebf2b0831f85	jonastclausen@gmail.com	Jonas Clausen	$2a$10$rX2O.2GypigsoliwLij.z.Z275SgSO03k5/OVNuhYEy92TkMYx.tO	t	{user,admin}
8f0c743e-952b-4fda-aa98-b83ad243e989	jonas.clausen@fixsell.mx	jonas test user	$2a$10$Z9v64GFC7JbkYC/hLYeKUO57.A0NLGzPKp5FPUtkMZ8RmRtCgR0GC	t	{vendor,user}
\.
...
SELECT pg_catalog.setval('public.deal_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.package_id_seq', 24, true);
...
--
-- Name: printer REL_b2cbbe74d38c2c02ea11893caa; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.printer
    ADD CONSTRAINT "REL_b2cbbe74d38c2c02ea11893caa" UNIQUE ("dealId");
...
--
-- Name: consumible UQ_2a465ab5421304f86570e1a539e; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.consumible
    ADD CONSTRAINT "UQ_2a465ab5421304f86570e1a539e" UNIQUE ("counterpartId");
...
--
-- Name: printer FK_b2cbbe74d38c2c02ea11893caaf; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.printer
    ADD CONSTRAINT "FK_b2cbbe74d38c2c02ea11893caaf" FOREIGN KEY ("dealId") REFERENCES public.deal(id) ON DELETE SET NULL;
